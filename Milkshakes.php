...
<head>
    ...
    <title>Adiax-Shakes Category</title>
    <!-- Bootstrap CSS -->
...
?>
    ...
    <section class="category">
        <h3 class="text-center fst-italic fw-bolder text-monotypecorsiva"><u class="shadow">World's</u>&nbsp;&nbsp;<u class="shadow">Best</u>&nbsp;&nbsp;<u class="shadow">Milkshakes</u></h3>
        ...
        <div class="row g-5 my-auto mx-auto">
            <?php
            $sqlproduct = "SELECT * FROM `food_product` WHERE `product_type`='Milkshakes'";
