...
<head>
    ...
    <title>Adiax-Desserts Category</title>
    <!-- Bootstrap CSS -->
...
?>
    ...
    <section class="category">
        <h3 class="text-center fst-italic fw-bolder text-monotypecorsiva"><u class="shadow">Our's</u> <u class="shadow">Desserts</u></h3>
        ...
        <div class="row g-5 my-auto mx-auto">
            <?php
            $sqlproduct = "SELECT * FROM `food_product` WHERE `product_type`='Dessert'";
