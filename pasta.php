...
<head>
    ...
    <title>Adiax-Pasta Category</title>
    <!-- Bootstrap CSS -->
...
?>
    ...
    <div class="container-fluid bg-light text-primary pt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Pasta</li>
            </ol>
        </nav>
    </div>
    <!-- breadcrumb Ends -->
    ...
    <section class="category">
        <h3 class="text-center fst-italic fw-bolder text-monotypecorsiva"><u class="shadow">Our's</u> <u class="shadow">Pasta</u></h3>
        ...
        <div class="row g-5 my-auto mx-auto">
            <?php
            $sqlproduct = "SELECT * FROM `food_product` WHERE `product_type`='Pasta'";
