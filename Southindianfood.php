...
<head>
    ...
    <title>Adiax-South Indian Food Category</title>
    <!-- Bootstrap CSS -->
...
?>
    ...
    <div class="container-fluid bg-light text-primary pt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">South Indian Foods</li>
            </ol>
        </nav>
    </div>
    <!-- breadcrumb Ends -->
    ...
    <section class="category">
        <h3 class="text-center fst-italic fw-bolder text-monotypecorsiva"><u class="shadow">Our's</u> <u class="shadow">South Indian Food</u></h3>

        <!-- South Indian Food Started -->
        <!-- <h2 class="px-5 pt-5">
            South Indian Food
        </h2> -->
        <div class="row g-5 my-auto mx-auto">
            <?php
            $sqlproduct = "SELECT * FROM `food_product` WHERE `product_type`='South Indian Food'";
