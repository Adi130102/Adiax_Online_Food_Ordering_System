...
<head>
    ...
    <title>Adiax-Fruit Juices Category</title>
    <!-- Bootstrap CSS -->
...
?>
    ...
    <div class="container-fluid bg-light text-primary pt-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="Beverages.php" class="text-primary">Beverages</a></li>
                <li class="breadcrumb-item active" aria-current="page">Fruit Juices</li>
            </ol>
        </nav>
    </div>
    <!-- breadcrumb Ends -->
    ...
    <section class="category">
        <h3 class="text-center fst-italic fw-bolder text-monotypecorsiva"><u class="shadow">Our's</u> <u class="shadow">Fruit Juices</u></h3>

        <!-- Fruit Juices Started -->
        <!-- <h2 class="px-5 pt-5">
            Fruit Juices
        </h2> -->
        <div class="row g-5 my-auto mx-auto">
            <?php
            $sqlproduct = "SELECT * FROM `food_product` WHERE `product_type`='Juice'";
